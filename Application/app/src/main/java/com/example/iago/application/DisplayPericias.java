...
public class DisplayPericias extends Activity {

    // Lista de pericias
    private final String[][] ESTADOS = new String[][] {{"Acre", "1"},{"Amapá", "2"}};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> lsvEstadosAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1) {
            ...
            public View getView(int position,View convertView, ViewGroup parent) {
                ...
                String val = ESTADOS[position][1];
                View v = convertView;

                if(v==null) {
                    LayoutInflater inflater = getLayoutInflater();
                    v = (View) inflater.inflate(R.layout.activity_display_pericias, null);
                }

                CheckBox check = (CheckBox) v.findViewById(R.id.chkPericia);
                ...
                TextView txvEstado = (TextView) v.findViewById(R.id.textPericia);
                TextView txvVal = (TextView) v.findViewById(R.id.textPericiaVal);
